...
@click.option("-t", "--use-time", default=None)
def create(file_uris, file_uris_file=None, prefix=DEFAULTS["prefix"], 
           ...
           s3_config_file=None, cache_dir=None, use_time=None):
    """
    ...
    indexer = Indexer(s3_config=s3_config, max_bytes=max_bytes, cache_dir=cache_dir, use_time=use_time)
